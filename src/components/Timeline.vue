        ...
        <ul class="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
            <li>
                ...
                <div class="timeline-start mb-10 md:text-end">
                    <div class="text-lg font-black">March 1997</div>
                    I started existing. Yay!
                </div>
                <hr />
            </li>
            <li>
            ...
            <li>
                ...
                <div class="timeline-start mb-10 md:text-end">
                    ...
                    million iPod products as of 2022. Apple discontinued the iPod product line on May 10, 2022.
                    At
